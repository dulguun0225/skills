---
name: caching
description: Cache rules for any repo, any language. ALWAYS load before adding a cache, a memo, a loading cache, a caching annotation or an expiry, deciding whether a repo needs a cache at all, putting a cache behind a proxy or a content-delivery network, or caching a value another rule set governs.
---
# Cache discipline
