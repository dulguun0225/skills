---
name: money-api
description: Rules for money crossing a process boundary. ALWAYS load before adding or changing a request or response payload, a schema or an endpoint that carries an amount of money, and before parsing or producing a file that carries one, such as a batch import, a statement, a settlement report or a spreadsheet upload.
---
