...
description: How to write a rule that actually binds an LLM agent; defines the enforcement markers and status tiers this skill set uses. ALWAYS load before writing or revising a coding rule, a constitution, a lint policy, an architecture test, a CLAUDE.md rule, or any text meant to override an agent's default behaviour.
---
