...
description: Picks an LLM makes by training-data default, banned by name; owns the jqwik version pin for every stack skill here. ALWAYS load before adding or bumping a dependency, pinning a tool, a CI action or a container image reference, wiring or editing CI, picking a property-test, holiday or units library, storing a deadline, or writing a security review's mitigations.
---
