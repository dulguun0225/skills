...
description: How to choose and compose the machine gates that replace human code review. ALWAYS load before adopting a static analyser, scanner, coverage or mutation tool, contract or migration lint, wiring or removing a CI gate, adding a suppression or a baseline file, changing branch protection or a shared workflow, or claiming a defect class is covered.
---
