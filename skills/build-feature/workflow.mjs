...
const TIERS = {
  ...
  reviewSpec: { model: 'fable', effort: 'high' },
  fixSpec: { model: 'opus', effort: 'medium' },
  plan: { model: 'fable', effort: 'xhigh' },
  reviewPlan: { model: 'fable', effort: 'high' },
  fixPlan: { model: 'fable', effort: 'medium' },
  tasks: { model: 'opus', effort: 'medium' },
  analyze: { model: 'opus', effort: 'medium' },
  remediate: { model: 'opus', effort: 'medium' },
  remediateCritical: { model: 'fable', effort: 'medium' },
  phases: { model: 'sonnet', effort: 'low' },
  implement: { model: 'fable', effort: 'medium' },
  converge: { model: 'fable', effort: 'high' },
