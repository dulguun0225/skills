---
name: money-java
description: Java build checks for the money rules. ALWAYS load in a Java repo alongside money, money-api and money-storage, before adding a money type, a money field, a rounding step, a money endpoint, a money column, a migration, or a query that reads an amount.
---
