---
name: caching-java
description: Java build checks for the caching rules, plus the cache engine pick. ALWAYS load in a Java repo alongside caching, before adding a cache, a memo, a loading cache, a caching annotation, an expiry or a cache engine.
---
