...
description: Procedure a technology decision clears before it becomes a rule; defines the four confidence markers this skill set uses. ALWAYS load before picking a library, a framework, a datastore, an architecture or a tool, grading the evidence behind a decision someone else made, or re-dating a decision that has gone stale.
---
