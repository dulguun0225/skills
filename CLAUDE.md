...
- [firing-harness](docs/history/firing-harness.md) — `npm run firing`, the only check here that reaches a `description`; the A/B that cleared the context-budget trim, and the set-wide baseline it found instead
